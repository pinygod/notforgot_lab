...
class CreateNoteActivity : AppCompatActivity(), DatePickerDialog.OnDateSetListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        initCategoriesList()
        initPrioritiesList()
        categorySpinnerAdapter = ArrayAdapter(this, R.layout.spinner_item, categoriesList)
        categorySpinner.adapter = categorySpinnerAdapter
        prioritySpinnerAdapter = ArrayAdapter(this, R.layout.spinner_item, prioritiesList)
            ...
            if (InputValidation(this).isInputEditTextFilled(
                ...
                if (isRedacting) {
                    ...
                    if (categoryName != defaultCategory && priority != defaultPriority) {
                        ...
                        Toast.makeText(this, R.string.succesfull_save, Toast.LENGTH_SHORT).show()
                        finish()
                    }
                    else{
